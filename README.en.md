...
**FullStack** software engineer with over 18 years of end-to-end development experience — from Java backend (Spring Boot, Spring Cloud, EJB) to frontend (Angular, React, Next.js) and infrastructure (Docker, GitLab CI, GitHub Actions, CI/CD). Works with microservices architectures, async messaging (RabbitMQ, Kafka), contract-first APIs (OpenAPI), code quality (JaCoCo, Checkstyle, SpotBugs, PMD) and test coverage (JUnit, Mockito, Testcontainers).

## Technology Experience

- Languages & runtime: Java 5–8, 11 and 17+, TypeScript, JavaScript, Shell Script, PL/SQL, Node.js, Python
- Backend: Spring Boot, Spring Security, Spring Cloud, Spring Data, JPA, EJB
- Frontend: Angular 5–7 and 15+, React, Next.js
- Architecture & integration: microservices, API Gateway, Service Discovery, Kafka, RabbitMQ, REST/OpenAPI
- Databases: Oracle, PostgreSQL, MySQL, MongoDB, H2
- Testing: JUnit, Mockito, Testcontainers
- Quality: JaCoCo, Checkstyle, PMD, SpotBugs, Spotless, ZapScan
- DevOps & delivery: Docker, Docker Compose, GitLab CI, GitHub Actions, Codecov

## Projects

| Project | What it demonstrates | Main Stack | Link |
| --- | --- | --- | --- |
| desafioMagalu | REST API for communication scheduling with OpenAPI, contract validation, Testcontainers and schema versioning via Flyway. | Spring Boot 4, MySQL, OpenAPI, Testcontainers | [Repository](https://github.com/leoalmeida/desafioMagalu) |
...
- GitHub: [github.com/leoalmeida](https://github.com/leoalmeida)
